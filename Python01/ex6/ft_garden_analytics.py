...
class Plant:
    ...
    @classmethod
    def anonymous(cls, name: str | None = None,
                  height: float = 0.0, age: int = 0) -> Self:
        if name is None:
            name = "Unknown plant"
...
def show_statistics(plant: Plant) -> None:
    print(f"Stats: {plant._statistics._grow_calls} grow,"
...
class Tree(Plant):
    ...
    def produce_shade(self) -> None:
        print(f"Tree {self._name} now produces a "
              f"shade of {self._height}cm long and "
